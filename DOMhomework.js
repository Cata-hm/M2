...
function buildToDos(toDos) {
  // Tu código acá:
  var array = toDos.map(buildToDo); //acá es como si estuvieramos usando la función de builToDos, línea 53, la ejecutará por cada elemento
...
function displayToDos() {
  ...
  var aux = buildToDos(toDoItems); // paso 3)
